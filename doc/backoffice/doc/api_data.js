define({ "api": [
  ...
  },
  {
    ...
    "name": "getComptes",
    "version": "0.1.0",
    "description": "<p>Accès à toutes les ressources de type compte de l'utilisateur connecté : permet d'accéder à la représentation des ressources compte que l'ulisateur va pouvoir consulter et modifier, Retourne une liste de lien pour twig.</p>",
    "success": {
      "fields": {
        "Succès : 200": [
          {
